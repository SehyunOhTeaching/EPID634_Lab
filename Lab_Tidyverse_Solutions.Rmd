...
write_csv(product_region_summary, 'output/product_region_summary.csv')
write_csv(top_customers, 'output/top_customers.csv')
write_csv(monthly_trends, 'output/monthly_trends.csv')
write_csv(revenue_matrix, 'output/revenue_matrix.csv')
