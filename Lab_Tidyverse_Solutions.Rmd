...
write_csv(product_region_summary, 'data/product_region_summary.csv')
write_csv(top_customers, 'data/top_customers.csv')
write_csv(monthly_trends, 'data/monthly_trends.csv')
write_csv(revenue_matrix, 'data/revenue_matrix.csv')
